    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                ...
                <div class="welcome-message flex-grow-1">Your're logged in as, <?php echo $_SESSION['username']; ?>!
                </div>
                <button id="logoutButton" class="nav-link btn btn-link" data-bs-toggle="modal" data-bs-target="#logoutModal"><i class="fa-solid fa-right-from-bracket"></i></button>
            </div>
...
<div class="row mb-3">
    ...
    <span id="executor_display" class="form-control"><?php echo $_SESSION['username']; ?></span>
    <input type="hidden" id="executor" name="executor" value="<?php echo $_SESSION['username']; ?>">
</div>
                        <div class="modal-footer">
